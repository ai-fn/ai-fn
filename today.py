...
USER_NAME = os.environ["USER_NAME"]  # 'ai-fn'
QUERY_COUNT = {
    "user_getter": 0,
    "follower_getter": 0,
    "graph_repos_stars": 0,
...
if __name__ == "__main__":
    ...
    # e.g {'id': 'MDQ6VXNlcjgyMjg5NjQz'} and 2019-11-03T21:15:07Z for username 'ai-fn'
    user_data, user_time = perf_counter(user_getter, USER_NAME)
    OWNER_ID, acc_date = user_data
    formatter("account data", user_time)
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2003, 9, 13))
